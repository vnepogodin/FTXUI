...
static constexpr Interval g_combining_characters[] = {
...
static constexpr Interval g_full_width_characters[] = {
...
constexpr int Bisearch(uint32_t ucs, const Interval* table, int max) {
